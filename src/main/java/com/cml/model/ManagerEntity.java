 ...
 */
@Entity
@Table(name = "manager", schema = "", catalog = "db_cmlearning")
public class ManagerEntity {
    ...
    @Basic
    @Column(name = "tellphone", nullable = true, insertable = true, updatable = true, length = 11)
    ...
    @Basic
    @Column(name = "del_flag", nullable = false, insertable = true, updatable = true, length = 1)
    ...
    public boolean equals(Object o) {
        ...
        if (tellphone != null ? !tellphone.equals(that.tellphone) : that.tellphone != null) return false;
